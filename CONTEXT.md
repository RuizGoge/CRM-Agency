...
### 🔬 R8 descargado (parcialmente) — 2026-08-01
...
- **Dirección propuesta, NO adoptada (es enmienda de arquitectura, la firma Jorge):** la evidencia de probe y los payloads de consumidor están en el mismo reloj sin razón — la ventana corta existe por minimización CCPA de PII, y un probe es evidencia operativa que debe sobrevivir a lo que certifica. Opción preferida: hogar propio sin reloj de retención, con la regla de que los probes se capturan solo contra sujetos sintéticos.
